...
<div id="NlsHunter_settings" class="wrap">
    ...
    <form method="POST">
        ...
        <section id="hunter_page_settings">
            ...
            <p>[Shortcodes]</p>
            <?= $this->adminSelectPage(NlsHunter_Admin::NLS_APPLICATION_FORM, $nlsApplicationForm, 'Home - Hunter Application Form') ?>
            <small>* The page must have the slug <i>[nls_application_form]</i></small>
            <br>
            <!--
